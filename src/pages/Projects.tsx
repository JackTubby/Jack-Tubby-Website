              ...
              <div className="absolute bottom-2 left-2 flex flex-col gap-y-2 bg-black/40 backdrop-blur-md p-4 rounded-xl w-[90%]">
                ...
                <div className="flex gap-x-4">
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-center cursor-pointer text-white rounded-2xl px-4 py-1 max-w-1/2 bg-linear-to-r from-emerald-400 via-teal-500 to-cyan-600 transition-all duration-500 ease-out text-sm"
                  >
                    View UI on GitHub
                  </a>
                  <a
